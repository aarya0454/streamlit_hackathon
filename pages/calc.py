...
<style>
    ...
    :root {
        ...
        --gradient-warning: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
    ...
    /* Enhanced Metric cards with cool animations */
    ...
    .stTextArea > div > div > textarea:focus {
        border-color: var(--warning-color) !important;
        box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1), 0 4px 8px rgba(0, 0, 0, 0.1) !important;
    ...
    .stWarning {
        background: linear-gradient(135deg, rgba(255, 193, 7, 0.1) 0%, rgba(255, 235, 59, 0.1) 100%) !important;
    ...
    /* Custom recommendation boxes with enhanced gradients */
    .recommendation-box {
        background: var(--gradient-success) !important;
        color: #ffffff !important;
    ...
    .recommendation-box::before {
        ...
        background: repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(255,255,255,0.1) 10px, rgba(255,255,255,0.1) 20px) !important;
        animation: shimmer 20s linear infinite !important;
    }
    
    .recommendation-box h2, .recommendation-box h3, .recommendation-box p {
        color: #ffffff !important;
    ...
    .design-card, .cost-card, .alert-card, .success-card {
        background-color: var(--bg-card) !important;
        color: var(--text-primary) !important;
        border: 1px solid var(--border-color) !important;
        border-radius: 16px !important;
    ...
    .design-card:hover, .cost-card:hover, .alert-card:hover, .success-card:hover {
        box-shadow: 0 12px 35px rgba(0, 0, 0, 0.15) !important;
        transform: translateY(-4px) !important;
    }
    
    .design-card h4, .design-card h3, .design-card h2, .design-card p, .design-card li, .design-card strong,
    .cost-card h4, .cost-card h3, .cost-card h2, .cost-card p, .cost-card li, .cost-card strong,
    .alert-card h4, .alert-card h3, .alert-card h2, .alert-card p, .alert-card li, .alert-card strong,
    .success-card h4, .success-card h3, .success-card h2, .success-card p, .success-card li, .success-card strong {
        color: var(--text-primary) !important;
    }
    ...
    .cost-card {
        border-left: 4px solid var(--warning-color) !important;
        background: linear-gradient(135deg, rgba(102, 126, 234, 0.02) 0%, var(--bg-card) 100%) !important;
    }
    
    .alert-card {
        border-left: 4px solid var(--error-color) !important;
        background: linear-gradient(135deg, rgba(240, 147, 251, 0.02) 0%, var(--bg-card) 100%) !important;
    }
    
    .success-card {
        border-left: 4px solid var(--success-color) !important;
        background: linear-gradient(135deg, rgba(17, 153, 142, 0.02) 0%, var(--bg-card) 100%) !important;
    }
